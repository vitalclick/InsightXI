...
> **Pick of the Day**, the day's single best bet. The API needs the AI service
> reachable and fixtures in the DB for that bet to be real; keep both healthy.
> (See `CLAUDE.md` → *Core Focus*.)
